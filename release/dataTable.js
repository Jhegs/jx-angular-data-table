...
(function (global, factory) {
  ...
  function PagerDirective() {
    return {
      ...
      template: "<div class=\"dt-pager\">\n        <ul class=\"pager\">\n          <li ng-class=\"{ disabled: !pager.canPrevious() }\">\n            <a href ng-click=\"pager.selectPage(1)\" ><md-icon class=\"material-icons\" style=\"font-size:16px; line-height:12px; margin: -4px;\">skip_previous</md-icon></a>\n          </li>\n          <li ng-class=\"{ disabled: !pager.canPrevious() }\">\n            <a href ng-click=\"pager.prevPage()\" class=\"icon-left\"><md-icon class=\"material-icons\" style=\"font-size:16px; line-height:10px; margin: -4px;\">keyboard_arrow_left</md-icon></a>\n          </li>\n          <li ng-repeat=\"pg in pager.pages track by $index\" ng-class=\"{ active: pg.active }\">\n            <a href ng-click=\"pager.selectPage(pg.number)\">{{pg.text}}</a>\n          </li>\n          <li ng-class=\"{ disabled: !pager.canNext() }\">\n            <a href ng-click=\"pager.nextPage()\" class=\"icon-right\"><md-icon class=\"material-icons\" style=\"font-size:16px; line-height:10px; margin: -4px;\">keyboard_arrow_right</md-icon></a>\n          </li>\n          <li ng-class=\"{ disabled: !pager.canNext() }\">\n            <a href ng-click=\"pager.selectPage(pager.totalPages)\" class=\"icon-skip\"><md-icon class=\"material-icons\" style=\"font-size:16px; line-height:10px; margin: -4px;\">skip_next</md-icon></a>\n          </li>\n        </ul>\n      </div>",
      replace: true
    };
  }
